---
title: 'Uniswap API and Interface'
---

# Uniswap API and Interface

[Uniswap interface](https://app.uniswap.org/) and [Routing API](https://docs.uniswap.org/api/overview) are managed by Uniswap Labs, and all the routing logic is handled by their team.
